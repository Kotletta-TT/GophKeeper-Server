...
const (
	...
	MetaSecretCardService_ListMetaSecretCard_FullMethodName   = "/v1.MetaSecretCardService/ListMetaSecretCard"
)
...
type MetaSecretCardServiceClient interface {
	...
	ListMetaSecretCard(ctx context.Context, in *ListMetaSecretCardRequest, opts ...grpc.CallOption) (*ListMetaSecretCardResponse, error)
}
...
func (c *metaSecretCardServiceClient) ListMetaSecretCard(ctx context.Context, in *ListMetaSecretCardRequest, opts ...grpc.CallOption) (*ListMetaSecretCardResponse, error) {
	out := new(ListMetaSecretCardResponse)
	err := c.cc.Invoke(ctx, MetaSecretCardService_ListMetaSecretCard_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MetaSecretCardServiceServer interface {
	...
	ListMetaSecretCard(context.Context, *ListMetaSecretCardRequest) (*ListMetaSecretCardResponse, error)
...
func (UnimplementedMetaSecretCardServiceServer) ListMetaSecretCard(context.Context, *ListMetaSecretCardRequest) (*ListMetaSecretCardResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListMetaSecretCard not implemented")
}
...
func _MetaSecretCardService_ListMetaSecretCard_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListMetaSecretCardRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MetaSecretCardServiceServer).ListMetaSecretCard(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MetaSecretCardService_ListMetaSecretCard_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MetaSecretCardServiceServer).ListMetaSecretCard(ctx, req.(*ListMetaSecretCardRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var MetaSecretCardService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ListMetaSecretCard",
			Handler:    _MetaSecretCardService_ListMetaSecretCard_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "secretcard.proto",
